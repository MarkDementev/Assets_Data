...
public class FinancialAndAnotherConstants {
    ...
    public static final Integer STANDARD_BOND_PAR_VALUE = 1000;
    public static final Float STANDARD_BOND_PURCHASE_MARKET_PRICE = 100.00F;
    public static final Float RUSSIAN_FIXED_RATE_BONDS_TAX_SYSTEM_CORRECTION = 0.87F;
}
